    ...
    public partial class Form1 : Form
    {
       ...
       List<Pet> listpet = new List<Pet>();
        ...
        private void btnSalvar_Click(object sender, EventArgs e)
        {
            ...
            animal.Especie = cbxEspécie.Text;
        ...
        private void btnPesquisar_Click(object sender, EventArgs e)
        {
            ...
            for(int i =0; i < listpet.Count; i++)
            {
                if (txtPet.Text.Equals(listpet[i].Animal))
                {
                    ...
                    cbxEspécie.Text = listpet[i].Especie;
                    op = 1;
                    break;
        ...
        private void cbxEspécie_SelectedIndexChanged(object sender, EventArgs e)
        {
